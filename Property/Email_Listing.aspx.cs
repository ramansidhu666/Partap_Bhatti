    ...
    public partial class Email_Listing : System.Web.UI.Page
    {
        ...
        public string GetPropertyDetails()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                html.AppendLine("<h2 style='font-weight:bold; font-size:16px;'>Partap Bhatti for Property ID  " + dt.Rows[0]["MLS"].ToString() + ";</h2>");
                ...
                html.AppendLine("<p>http://partapbhatti.com/</p>");
                ...
                html.AppendLine("<p>For more information visit <a href='#'>http://partapbhatti.com/</a> </p></div>");
                html.AppendLine("<div style='float:left; padding-left:12px;'>");
                html.AppendLine("<p style='margin:0px;'>Listed By</p><br/><p>Partap Bhatti<br/>Broker Of Record</p>");
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Website:</p><span style='float:left;'>http://partapbhatti.com/</span><br/></div></div>");
                html.AppendLine("<div style='float:left; width:100%;'>");
